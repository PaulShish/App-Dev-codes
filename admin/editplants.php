                                ...
                                <form action="https://desarsgreenhands.com/admin/php/post_edit_plants.php/?id=<?php echo $product_id ?>" method="post" enctype="multipart/form-data">
                                    <fieldset>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-3">
                                                <input type="text" name="color_of_plant"  class="form-control" value="<?php echo $rows_product_detail['color_of_plant']?>">
                                            </div>
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">Bloom Time</label>
                                            </div>
                                            <div class="col-12 col-md-3">
                                                <input type="text" name="bloom_time_of_plant"  class="form-control" value="<?php echo $rows_product_detail['bloom_time_of_plant']?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-3">
                                                <input type="text" name="height_range_of_plant"  class="form-control" value="<?php echo $rows_product_detail['height_range_of_plant']?>">
                                            </div>
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">Space Range</label>
                                            </div>
                                            <div class="col-12 col-md-3">
                                                <input type="text" name="space_range_of_plant"  class="form-control" value="<?php echo $rows_product_detail['space_range_of_plant']?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-3">
                                                <input type="text" name="lowest_temperature_of_plant"  class="form-control" value="<?php echo $rows_product_detail['lowest_temperature_of_plant']?>">
                                            </div>
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">Plant Light</label>
                                            </div>
                                            <div class="col-12 col-md-3">
                                                <input type="text" name="plant_light_of_plant"  class="form-control" value="<?php echo $rows_product_detail['plant_light_of_plant']?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-3">
                                                <input type="text" name="usda_of_plant"  class="form-control" value="<?php echo $rows_product_detail['usda_of_plant']?>">
                                            </div>
                                            <div class="col col-md-3">
                                                <label for="text-input" class=" form-control-label">Pest & Diseases</label>
                                            </div>
                                            <div class="col-12 col-md-3">
                                                <input type="text" name="pest_of_plant"  class="form-control" value="<?php echo $rows_product_detail['pest_of_plant']?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-3">
                                                <input type="text" name="stock"  class="form-control" value="<?php echo $rows_product_detail['stock']?>">
                                            </div>
                                        </div>
