...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <!-- MAIN CONTENT-->
            <?php
                $get_username = "SELECT username FROM `transaction_orders` WHERE transaction_order_number = '$transaction_order_number'";
                $result_username = mysqli_query($db,$get_username) or die('Could not query');
                $row_username=$result_username->fetch_assoc();

                $data = $row_username['username'];

                $query_billing_details = "SELECT * FROM `billing_details` WHERE username = '$data'";
                            ...
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    ...
                                    <form action="https://desarsgreenhands.com/admin/php/check_order.php?id=<?php echo $transaction_order_number ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <select name="selectAction" id="select" class="form-control">
