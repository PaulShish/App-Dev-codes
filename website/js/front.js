$(function () {
    ...
    /* ===============================================================
      ...
      $('.inc-btn').click(function () {
          ...
          var maxValue = parseFloat($(this).siblings('input').getAttribute('data-max'));
            var currentValue = parseFloat($(this).siblings('input').value);
            
            if (isNaN(currentValue)) {
                $(this).siblings('input').value = "";
            } else if (currentValue > maxValue) {
                //$(this).siblings('input').value = maxValue;
                siblings.val(maxValue);
            }
      });
