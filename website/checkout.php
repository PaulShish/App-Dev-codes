...
include_once ('/home/desarsgr/public_html/php/session.php'); 
$cart = new Cart;
...
echo("<script>console.log('PHP: " . $login_session . "');</script>");
?>
<!DOCTYPE html>
<html>
  <head>
          ...
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="https://desarsgreenhands.com/"><span class="font-weight-bold text-uppercase text-dark">Desar's Green Hands</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul class="navbar-nav ml-auto">               
                ...
                <li class="nav-item">
                  <a class="nav-link" href="login.php">Hello, <?php echo $login_name1?></a>
                </li>
              </ul>
            </div>
          </nav>
