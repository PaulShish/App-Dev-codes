<?php
  ...
  if ($category == "all")
  {
    ...
    $query_products = "SELECT * FROM `plants_info` WHERE deleted = 0 AND stock >= 1 ORDER BY id DESC";

    $query_count = "SELECT COUNT(id) AS Total FROM `plants_info` WHERE stock >= 1";
  ...
  else if ($category == "search")
  {
    ...
    $query_products = "SELECT * FROM `plants_info` WHERE name_of_plant like '%$search%' AND deleted = 0 AND stock >= 1 ORDER BY id ASC";
  ...
  {
    $query_products = "SELECT * FROM `plants_info` WHERE type_of_plant = $category AND deleted = 0 AND stock >= 1 ORDER BY id ASC";

    $query_count = "SELECT COUNT(id) AS Total FROM `plants_info` WHERE type_of_plant = $category AND stock >= 1";
    $result_count = mysqli_query($db,$query_count) or die('Could not query');
    $rows_count=$result_count->fetch_assoc();
