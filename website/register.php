  ...
  <body>
    <div class="page-holder">
      ...
      <div class="container">
        ...
        <section class="py-5">
          <!-- BILLING ADDRESS-->
          <h2 class="h5 text-uppercase mb-4">User details</h2>
          <div class="row">
            <div class="col-lg-8">
              <form id="form" action="php/addressAction.php?action=addAddress" method="post">
                <fieldset>
                  <div class="row">
                    ...
                    <div class="col-lg-6 form-group">
                      <label class="text-small text-uppercase" for="firstName">Username</label>
                      <input class="form-control form-control-lg" id="username" name="username" type="text" placeholder="Enter your username" required>
                    </div>
                    <div class="col-lg-6 form-group">
                    ...
                    <div class="col-lg-6 form-group">
                      <label class="text-small text-uppercase" for="cpassword">Re-enter Password</label>
                      <input class="form-control form-control-lg" id="cpassword" name="cpassword" type="password" placeholder="Re-enter your password" required>
                    </div>
                    <div class="col-lg-6 form-group">
                    </div>
                    <div class="col-lg-6 form-group">
