  ...
  <body onload="cart()">
    <div class="page-holder">
      ...
      <div class="container">
        ...
        <section class="py-5">
          <h2 class="h5 text-uppercase mb-4" style="text-align:center">You canceled the session. going back to your cart.</h2>
        </section>
      </div>
      ...
      <script>
        function cart(){
            setTimeout(function(){ window.location.replace("https://desarsgreenhands.com/cart.php");}, 3000);
        }
        </script>
